...
public class BrushPowerShell extends Brush {
    ...
    public BrushPowerShell() {
        ...
        regExpRule.add(new RegExpRule("\\$[a-zA-Z0-9]+\\b", "value")); // variables $Computer1
        regExpRule.add(new RegExpRule("\\-[a-zA-Z]+\\b", "keyword")); // Operators    -not  -and  -eq
        ...
        regExpRule.add(new RegExpRule(getKeywords("Add-Content Add-History Add-Member Add-PSSnapin Clear(-Content)? Clear-Item "
        ...
        regExpRule.add(new RegExpRule(getKeywords("ac asnp clc cli clp clv cpi cpp cvpa diff epal epcsv fc fl "
        ...
        commonFileExtensionList = Arrays.asList(new String[]{"ps1"});
    }
}
