...
public class BrushCss extends Brush {
    ...
    public BrushCss() {
        ...
        regExpRule.add(new RegExpRule("(-?\\d+)(\\.\\d+)?(px|em|pt|\\:|\\%|)", "value")); // sizes
        regExpRule.add(new RegExpRule("!important", "color3")); // !important
        ...
        regExpRule.add(new RegExpRule(getKeywords("[mM]onospace [tT]ahoma [vV]erdana [aA]rial [hH]elvetica [sS]ans-serif [sS]erif [cC]ourier mono sans serif"), "color1")); // fonts

        commonFileExtensionList = Arrays.asList(new String[]{"css"});
    }
